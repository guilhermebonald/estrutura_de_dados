class No:
    def __init__(self, valor, ponteiro=None):
        ...
        Cada "Nó" é acompanhado por um "ponteiro", o cada "Nó" é "carregado" com uma "valor" e ocupa um espaço
        em "memória", cada "ponteiro" é "vazio" "None" ou "Null" e ocupa um espaço em "memória" que "aponta" para um
        possivel novo nó.
        """
        self.valor = valor
